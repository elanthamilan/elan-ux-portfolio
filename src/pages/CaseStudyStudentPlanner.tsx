...
import { ElanThinking } from "@/components/CaseStudyAccordion";
          ...
          <main className="flex-grow container mx-auto px-6 py-16 md:py-24 bg-brand-light-gray-accent/50">
            ...
            <article className="max-w-3xl mx-auto">
               ...
               <section className="mb-16 md:mb-20 prose prose-lg prose-neutral dark:prose-invert max-w-none prose-headings:font-dm-serif prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-3xl prose-h2:md:text-4xl prose-h2:font-semibold prose-h3:text-xl prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
                 <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-6 text-foreground">The Challenge: A Frustrated Student and a Clunky System</h2>
                 <p>
               ...
               <section className="mb-16 md:mb-20 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-heading prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-3xl prose-h2:md:text-4xl prose-h2:font-semibold prose-h3:text-xl prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
                 <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-6 text-foreground">Project Background: A Mission to Modernize</h2>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-lg text-foreground/80">
                   ...
                   <div>
                     <h3 className="font-heading font-semibold">Business Goals:</h3>
                     <ul>
               ...
               <section className="mb-16 md:mb-20 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-heading prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-4xl prose-h2:font-semibold prose-h3:text-xl prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
                 <h2 className="text-3xl md:text-4xl font-heading font-semibold mb-6 text-foreground">Understanding the Users: Pain Points and Insights</h2>
                 <p>
                 ...
                 <div className="border border-brand-light-gray-accent rounded-lg p-6 my-6 not-prose">
                   <h3 className="text-xl font-heading font-semibold mb-4 text-foreground">Key Pain Points:</h3>
...
{/* User Research Insights / Affinity Mapping */}
           <div className="aspect-video w-full rounded-lg my-12 shadow-md overflow-hidden">
             <img
               src="/Elanable-uploads/Camu.png"
               alt="User Research Insights / Affinity Mapping"
               className="w-full h-full object-cover"
             />
           </div>
           ...
           <section className="mb-16 md:mb-20 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-heading prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-3xl prose-h2:md:text-4xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 not-prose">
                <div className="border border-brand-light-gray-accent rounded-lg p-6">
                  <h3 className="font-heading font-semibold text-lg mb-2 text-foreground">Flexibility</h3>
                  <p className="text-foreground/80 text-sm leading-relaxed">Allow students to input nuanced constraints, like work hours and preferred times.</p>
                </div>
                <div className="border border-brand-light-gray-accent rounded-lg p-6">
                  <h3 className="font-heading font-semibold text-lg mb-2 text-foreground">Visualization</h3>
                  <p className="text-foreground/80 text-sm leading-relaxed">Offer a clear, intuitive calendar view that highlights conflicts and available options.</p>
                </div>
                <div className="border border-brand-light-gray-accent rounded-lg p-6">
                  <h3 className="font-heading font-semibold text-lg mb-2 text-foreground">AI Power</h3>
                  <p className="text-foreground/80 text-sm leading-relaxed">Use AI to suggest personalized schedules while keeping students in control.</p>
                </div>
             </div>
             <p>
           ...
           <div className="text-center mt-16">
             ...
             <div className="mb-8"> {/* Added margin bottom */}
               <h3 className="text-xl font-semibold mb-3 text-foreground">Next Case Study</h3>
...
<div className="mb-8">
               <h3 className="text-xl font-semibold mb-3 text-foreground">Conclusion</h3>
               <p className="text-foreground/80">
                 The Student Course Planner redesign demonstrates the importance of understanding user needs, iterating based on feedback,
                 and leveraging AI to personalize experiences. By focusing on these principles, we were able to create a tool that
                 empowers students to take control of their schedules and achieve their academic goals.
               </p>
             </div>
