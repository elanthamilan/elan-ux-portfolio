        ...
        <article className="max-w-4xl mx-auto">
          ...
          <SectionReveal>
            <section className={`mb-12 xs:mb-16 reveal px-3 py-5 xs:px-4 xs:py-6 sm:p-6 md:p-8 rounded-lg bg-gradient-to-br from-[${primaryColor}]/10 to-[${primaryColor}]/5 shadow-lg border border-[${primaryColor}]/20`}>
              ...
              <ul className="list-disc list-inside text-base xs:text-lg text-foreground/80 mb-4 pl-2 space-y-1">
          ...
          <SectionReveal>
            <section className={`mb-12 xs:mb-16 reveal px-3 py-5 xs:px-4 xs:py-6 sm:p-6 md:p-8 rounded-lg bg-gradient-to-br from-[${secondaryColor}]/10 to-[${secondaryColor}]/5 shadow-lg border border-[${secondaryColor}]/20`}>
              ...
              <p className="text-base xs:text-lg text-foreground/80 mb-1 font-medium">Key responsibilities included:</p>
          ...
          <SectionReveal>
            <section className={`mb-12 xs:mb-16 reveal px-3 py-5 xs:px-4 xs:py-6 sm:p-6 md:p-8 rounded-lg bg-gradient-to-br from-[${primaryColor}]/10 to-[${primaryColor}]/5 shadow-lg border border-[${primaryColor}]/20`}>
              ...
              <div className="mb-8 xs:mb-10">
                ...
                <p className="text-base xs:text-lg text-foreground/80 mb-4">Key pain points identified included:</p>
                <ul className="list-disc list-inside text-base xs:text-lg text-foreground/80 mb-4 pl-2 space-y-1">
                ...
                <blockquote className={`border-l-4 border-[${primaryColor}]/50 pl-3 xs:pl-4 sm:pl-6 italic text-foreground/80 my-6 xs:my-8 bg-white p-3 xs:p-4 rounded-r-lg shadow-sm reveal`}>
                  ...
                  <cite className="block text-sm text-right mt-2 not-italic">- Elan's Thinking</cite>
                </blockquote>
                <p className="text-base xs:text-lg text-foreground/90">
              ...
              <div className="mb-8 xs:mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                  ...
                  <div className="p-4 bg-green-50 border border-green-200 rounded-md">
                    ...
                    <p className="text-sm text-green-600">A streamlined ~45-minute experience with a 90% task completion rate, featuring: Quick Setup, Intelligent Course Discovery, Automated Schedule Planning, and easy Optimization & Confirmation.</p>
                  </div>
                </div>
          ...
          <SectionReveal>
            <section className={`mb-12 xs:mb-16 reveal px-3 py-5 xs:px-4 xs:py-6 sm:p-6 md:p-8 rounded-lg bg-gradient-to-br from-[${primaryColor}]/10 to-[${primaryColor}]/5 shadow-lg border border-[${primaryColor}]/20`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="text-lg xs:text-xl font-semibold mb-2" style={{color: primaryColor}}>Key Lessons Learned:</h3>
                ...
                <div>
                  <h3 className="text-lg xs:text-xl font-semibold mb-2" style={{color: primaryColor}}>Key Design Principles Applied:</h3>
                  <ul className="list-disc list-inside text-base xs:text-lg text-foreground/80 space-y-1 pl-2">
