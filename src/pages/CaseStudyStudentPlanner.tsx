    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
        ...
        <article className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-sans font-extrabold mb-4 text-foreground leading-tight">
          ...
          <div className="flex items-center space-x-4 text-sm text-foreground/60 mb-10">
             <span>Approx. 9 min read</span> {/* Example read time */}
          </div>
          ...
          <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
            <h2>The Challenge: A Frustrated Student and a Clunky System</h2>
            <p>
          ...
          <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
            <h2>Project Background: A Mission to Modernize</h2>
          ...
          <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
            <h2>Understanding the Users: Pain Points and Insights</h2>
            <p>
            ...
            <div className="border border-brand-light-gray-accent rounded-lg p-6 my-6 not-prose"> 
              <h3 className="font-sans font-semibold text-lg mb-4 text-foreground">Key Pain Points:</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                 ...
                 <div className="flex items-start"><div className="flex-shrink-0 w-5 h-5 text-foreground/50 mr-3 mt-1"><svg fill="currentColor" viewBox="0 0 20 20"> <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.715-5.349L11 6.477V16h2a1 1 0 110 2H7a1 1 0 110-2h2V6.477L6.237 7.582l1.715 5.349a1 1 0 01-.285 1.05A3.989 3.989 0 015 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.738-5.42-1.233-.617a1 1 0 01.894-1.788l1.599.799L9 4.323V3a1 1 0 011-1z" clipRule="evenodd"></path> </svg></div><div><h4 className="font-medium text-foreground">Disconnected Steps</h4><p className="text-foreground/80 text-sm leading-relaxed">Planning and registration felt separate, with no seamless handoff.</p></div></div>
              </div>
            </div>
           ...
           <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
             <h2>The Solution: AI-Powered Scheduling with a Human Touch</h2>
             <p>
               Elan and the team reimagined the planner, focusing on three core principles:
             </p>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 not-prose">
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Flexibility</h3><p className="text-foreground/80 text-sm leading-relaxed">Allow students to input nuanced constraints, like work hours and preferred times.</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Visualization</h3><p className="text-foreground/80 text-sm leading-relaxed">Offer a clear, intuitive calendar view that highlights conflicts and available options.</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">AI Integration</h3><p className="text-foreground/80 text-sm leading-relaxed">Use AI to suggest personalized schedules while keeping students in control.</p></div>
             </div>
             <p>
           ...
           <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
             <h2>The Design Process: From Wireframes to Prototypes</h2>
              <p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8 not-prose">
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Wireframes</h3><p className="text-foreground/80 text-sm leading-relaxed">Focused on the core flow: inputting constraints, viewing suggestions, and registering for courses.</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Prototypes</h3><p className="text-foreground/80 text-sm leading-relaxed">Tested different calendar views and AI suggestion interfaces.</p></div>
             </div>
              <p>
           ...
           <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
             <h2>The Results: A Win for Students and the Business</h2>
             <p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 not-prose">
                <div className="border border-brand-light-gray-accent rounded-lg p-5 text-center"><h3 className="font-sans font-semibold text-2xl md:text-3xl mb-1 text-foreground">60%</h3><p className="text-foreground/80 text-sm leading-relaxed">Reduction in Scheduling Bottlenecks</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5 text-center"><h3 className="font-sans font-semibold text-2xl md:text-3xl mb-1 text-foreground">35%</h3><p className="text-foreground/80 text-sm leading-relaxed">Increase in Schedule-to-Cart Conversions</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5 text-center"><h3 className="font-sans font-semibold text-2xl md:text-3xl mb-1 text-foreground">45%</h3><p className="text-foreground/80 text-sm leading-relaxed">Adoption Rate of AI Advisor</p></div>
             </div>
             <p>
             ...
             <blockquote className="border-l-4 border-brand-light-gray-accent pl-6 italic text-foreground/70 my-8">
                <p className="mb-2"><strong className="not-italic font-sans font-medium text-foreground/90">Elan's Thinking: Measuring Success Beyond the Numbers</strong></p>
           ...
           <section className="mb-10 md:mb-12 prose prose-neutral dark:prose-invert max-w-none prose-headings:font-sans prose-p:leading-relaxed prose-p:text-foreground/80 prose-strong:text-foreground prose-strong:font-medium prose-headings:text-foreground prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:font-semibold prose-h3:text-lg prose-h3:font-semibold prose-li:my-1 prose-ul:pl-5">
             <h2>Lessons Learned: Empathy, Iteration, and the Power of AI</h2>
             <p>
               Elan walked away with three key lessons:
             </p>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8 not-prose">
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Empathy</h3><p className="text-foreground/80 text-sm leading-relaxed">Start with a deep understanding of user needs and pain points.</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">Iteration</h3><p className="text-foreground/80 text-sm leading-relaxed">Test and iterate based on user feedback.</p></div>
                <div className="border border-brand-light-gray-accent rounded-lg p-5"><h3 className="font-sans font-semibold text-lg mb-2 text-foreground">AI Power</h3><p className="text-foreground/80 text-sm leading-relaxed">Use AI to personalize experiences, but keep users in control.</p></div>
             </div>
             <p>
