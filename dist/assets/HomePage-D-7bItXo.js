  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: `flex flex-col items-start justify-between rounded-3xl shadow-md hover:shadow-lg hover:scale-[1.02] focus-within:ring-2 focus-within:ring-brand-primary focus-within:ring-offset-2 transition-all duration-300 ease-in-out ${skill.color} px-3 py-4 xs:p-4 ${skill.size === "large" ? "md:p-8" : "sm:p-6"} h-full border`,
          tabIndex: 0,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "flex flex-col items-start p-0 h-full text-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 xs:gap-3 mb-3 xs:mb-4", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: `font-semibold text-foreground ${skill.size === "large" ? "text-xl xs:text-2xl" : "text-lg xs:text-xl"}`, children: skill.title })
            ] }),
