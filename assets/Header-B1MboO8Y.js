...
const AnimatedFooterAccent = React.memo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 flex items-center justify-center pointer-events-none", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { ref: svgRef, width: "40", height: "40", viewBox: "0 0 40 40", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "circle",
    {
      cx: "20",
      cy: "20",
      r: prefersReducedMotion ? staticRadius : 4,
      fill: `hsla(${brandSecondaryHslStatic.h}, ${brandSecondaryHslStatic.s}%, ${brandSecondaryHslStatic.l}%, ${prefersReducedMotion ? 0.2 : 0.3})`,
