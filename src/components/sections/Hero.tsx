...
const Hero = () => {
  ...
  return (
    <section className={`py-10 md:py-16 text-foreground relative bg-gradient-to-br from-mesh-gradient-start via-mesh-gradient-middle to-mesh-gradient-end fade-in mb-20 ${loaded ? 'loaded' : ''}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 items-start"> {/* Adjusted gap */}
          ...
          <div className="space-y-8 md:space-y-10"> {/* Increased spacing */}
            <div>
              ...
              <h1 className="mt-4 mb-6 text-4xl md:text-5xl lg:text-6xl font-heading font-semibold leading-tight hero-text">
              ...
              <p className="text-foreground/80 text-lg md:text-xl max-w-xl mb-10 leading-relaxed hero-text"> {/* Intercom body text style */}
