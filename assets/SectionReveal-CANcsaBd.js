import { r as reactExports, j as jsxRuntimeExports, R as React, u as useLocation, A as AnimatePresence, m as motion, L as Link, b as React$1, a as reactDomExports, c as ReactDOM, d as j, g as gsapWithCSS, S as ScrollTrigger } from "./index-C4ZJcCGv.js";
/**
...
const buttonVariants = cva(
  ...
  // Updated base: rounded-lg, transition-all, focus ring, disabled opacity, svg sizing
  {
    variants: {
      variant: {
        default: (
        ...
        outline: (
          // Secondary action, often with a border
        ...
        ghost: (
          // For subtle actions, no background or border initially
          "text-foreground hover:bg-accent-bg hover:text-brand-primary active:scale-95"
        ),
        link: (
          // For navigation or actions that look like links
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.nav,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    className: "text-foreground hover:text-brand-primary hover:bg-brand-primary/10 dark:hover:bg-brand-primary/20",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col p-4 space-y-2 overflow-y-auto flex-grow", children: navItems.map((item) => item.isExternal ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                className: "flex items-center py-3 px-3 text-md font-medium text-foreground hover:bg-accent-bg dark:hover:bg-slate-700 hover:text-brand-primary rounded-md transition-colors",
                onClick: onClose,
                children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 mt-auto border-t border-slate-200 dark:border-slate-700", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-foreground/70 mb-3", children: "Contact Information" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://wa.me/918148622302", target: "_blank", rel: "noopener noreferrer", className: "flex flex-row items-center gap-2 border border-brand-primary text-brand-primary rounded-lg py-3 px-4 hover:bg-brand-primary/10 dark:hover:bg-brand-primary/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary transition-all w-full min-h-[52px] text-base font-medium justify-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { className: "w-5 h-5" }),
                  "WhatsApp"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "https://linkedin.com/in/elanthamilan", target: "_blank", rel: "noopener noreferrer", className: "flex flex-row items-center gap-2 border border-brand-primary text-brand-primary rounded-lg py-3 px-4 hover:bg-brand-primary/10 dark:hover:bg-brand-primary/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary transition-all w-full min-h-[52px] text-base font-medium justify-center", children: [
...
const ThemeToggle = () => {
  const { setTheme, theme, resolvedTheme } = j();
  reactExports.useEffect(() => {
  }, []);
  const Icon2 = resolvedTheme === "dark" ? Moon : Sun;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", size: "icon", "aria-label": "Toggle theme", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-[1.2rem] w-[1.2rem]" }) }) }),
...
const Header = React.memo(() => {
  ...
  const toggleMobileMenu = reactExports.useCallback(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "header",
      {
        className: `sticky top-0 z-40 bg-background/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 transition-all duration-300 ${isScrolled ? "shadow-lg" : "shadow-none"}`,
        role: "banner",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex justify-between items-center h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center space-x-4", "aria-label": "Main navigation", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "default",
                ...
                asChild: true,
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "/Elanthamilan_UX_Resume.pdf", target: "_blank", rel: "noopener noreferrer", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { className: "h-4 w-4 sm:h-5 sm:w-5", "aria-hidden": "true" }),
                  "Download Resume"
                ] })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:elanthamilan12@gmail.com", "aria-label": "Send Email", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 16, className: "flex-shrink-0 h-4 w-4 sm:h-5 sm:w-5" }),
                  "Email"
                ] })
              }
            ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: isMobileMenuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-6 w-6" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu$1, { className: "h-6 w-6" })
            }
          ) })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MobileNav, { isOpen: isMobileMenuOpen, onClose: toggleMobileMenu })
  ] });
});
Header.displayName = "Header";
const AnimatedFooterAccent = React.memo(() => {
  ...
  reactExports.useEffect(() => {
    ...
    gsapWithCSS.set(circle, {
      attr: { r: 4 },
      opacity: 0.1
      // Fill will be handled by Tailwind class
    });
    const tl = gsapWithCSS.timeline({ repeat: -1, yoyo: true });
    tl.to(circle, {
      attr: { r: 8 },
      // Pulse radius from 4 to 8
      opacity: 0.5,
      // Pulse opacity from 0.1 to 0.5
      duration: 3,
      // Slow duration for one way (e.g., 3 seconds)
      ease: "sine.inOut"
    }).to(circle, {
      // Explicitly define the return state for yoyo if needed, or let yoyo handle it
      attr: { r: 4 },
      opacity: 0.1,
      duration: 3,
      ease: "sine.inOut"
    ...
    return () => {
      if (circle) {
        gsapWithCSS.killTweensOf(circle);
      }
    };
  }, [prefersReducedMotion]);
  const staticRadius = 5;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 flex items-center justify-center pointer-events-none", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { ref: svgRef, width: "40", height: "40", viewBox: "0 0 40 40", className: "block", children: prefersReducedMotion ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    "circle",
    {
      cx: "20",
      cy: "20",
      r: staticRadius,
      className: "fill-brand-secondary/20 dark:fill-brand-secondary/40 opacity-30"
    }
  ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
    "circle",
    {
      ...
      cy: "20",
      r: 4,
      className: "fill-brand-secondary/30 dark:fill-brand-secondary/50"
    }
  ) }) });
});
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-accent-off-white/50 dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 text-foreground mt-16", role: "contentinfo", children: [
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 items-center mb-8 text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground", children: "Enterprise UX Designer specializing in Complex enterprise design" }),
          " "
        ] }),
  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        brand: "border-transparent bg-brand-badge-bg text-foreground hover:bg-brand-badge-bg/80"
      }
    },
    defaultVariants: {
      variant: "default"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isZoomed && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-sm bg-black/50 px-4 py-2 rounded-full backdrop-blur-sm", children: "Click outside or press Escape to close" })
            ]
          }
        ) })
      ]
...
const SectionReveal = React.memo(({ children }) => {
  ...
  reactExports.useEffect(() => {
    let st;
    if (ref.current) {
      gsapWithCSS.set(ref.current.querySelectorAll(".reveal"), { opacity: 1, y: 0 });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { ref, children });
});
...
//# sourceMappingURL=SectionReveal-CANcsaBd.js.map
