        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-[5fr_2fr] gap-8 md:gap-10 lg:gap-20">
          ...
          <div className="space-y-10">
            ...
            <section className="mb-16" aria-labelledby="hero-heading">
              ...
              <div className="mb-6">
                <div className="mb-2">
                  <motion.span 
                    className="inline-flex items-center px-4 py-2 rounded-full text-sm md:text-base font-bold uppercase tracking-wider bg-gradient-to-r from-brand-secondary/10 to-brand-secondary/5 border border-brand-secondary/20"
                    style={{ color: '#14B789' }}
                    initial={{ opacity: 0, scale: 0.95 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.6, ease: "easeOut" }}
                  >
                    <span className="w-2 h-2 bg-brand-secondary rounded-full mr-3 animate-pulse" aria-hidden="true"></span>
              ...
              >
                <div className="text-gray-800 leading-relaxed">
                  <div className="relative">
                    <div className="absolute -left-1 top-0 w-1 h-full bg-gradient-to-b from-brand-secondary to-brand-primary rounded-full opacity-60" aria-hidden="true"></div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-brand-secondary/10 to-brand-secondary/5 flex items-center justify-center group-hover:from-brand-secondary/15 group-hover:to-brand-secondary/10 transition-all duration-300">
                        <span className="material-symbols-outlined text-brand-secondary text-xl" aria-hidden="true">
                          {item.icon}
                        </span>
                      </div>
              ...
              >
                <AccessibleButton
                  ...
                  variant="default"
                  size="lg"
                  className="bg-brand-primary text-white font-medium rounded-2xl hover:bg-brand-primary/90 focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 shadow-lg hover:shadow-xl relative overflow-hidden"
                ...
                <AccessibleButton
                  ...
                  variant="outline"
                  size="lg"
                  className="border-2 border-brand-primary text-brand-primary font-medium rounded-2xl hover:bg-brand-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-brand-primary focus:ring-offset-2 bg-white/50 backdrop-blur-sm hover:shadow-lg"
          ...
          <div className="space-y-8 md:space-y-12 md:max-w-md lg:max-w-none mx-auto lg:mx-0">
            ...
            <section className="mb-8 md:mb-12 md:sticky md:top-24 md:z-10">
              ...
              >
                <h3 className="text-lg font-semibold mb-4 flex items-center" style={{ color: '#171717' }}>
