        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8 items-start">
          <div className="space-y-8 md:space-y-10">
            <div>
              ...
              <h1 ref={headlineRef} className="mt-4 mb-6 text-4xl md:text-5xl lg:text-6xl font-heading font-semibold leading-tight">
                {phrases[0]}
              </h1>
              
              <div className="flex items-center mb-8 space-x-2">
                <span className="text-xl md:text-2xl font-sans font-medium">Hi, I'm <span className="font-heading">Elan</span>👋🤓</span>
              </div>
              ...
              <div className="py-6 border-t border-b">
                <div className="px-0">
                  <h3 className="font-heading font-semibold mb-4 text-lg">Brands I Have Worked With</h3>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
                    <div className="text-center">
                      <img src="/Elanable-uploads/Camu.png" alt="Camu" width="80" height="40" />
                      <p className="text-xs mt-2">Camu</p>
                    </div>
                    <div className="text-center">
                      <img src="/Elanable-uploads/Mastek.png" alt="Mastek" width="80" height="40" />
                      <p className="text-xs mt-2">Mastek</p>
                    </div>
                    <div className="text-center">
                      <img src="/Elanable-uploads/Geninfy.jpg" alt="Geninfy" width="80" height="40" />
                      <p className="text-xs mt-2">Geninfy</p>
                    </div>
                    <div className="text-center">
                      <img src="/Elanable-uploads/Oceo.svg" alt="Oceo" width="80" height="40" />
                      <p className="text-xs mt-2">Oceo</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 py-6">
                <div className="text-center">
                  <span className="text-xs block uppercase tracking-wider">Experience</span>
                  <span className="font-semibold text-xl md:text-2xl block mt-1">8+ Years</span>
                </div>
                <div className="text-center">
                  <span className="text-xs block uppercase tracking-wider">Products</span>
                  <span className="font-semibold text-xl md:text-2xl block mt-1">10+</span>
                </div>
                 <div className="text-center">
                  <span className="text-xs block uppercase tracking-wider">Features</span>
                  <span className="font-semibold text-xl md:text-2xl block mt-1">30+</span>
                </div>
                 <div className="text-center">
                  <span className="text-xs block uppercase tracking-wider">Systems</span>
                  <span className="font-semibold text-xl md:text-2xl block mt-1">2</span>
                </div>
              </div>

              <div className="py-6 border-b">
                <h3 className="font-heading font-semibold mb-4 text-lg">Industries I have Worked In</h3>
                <Accordion type="single" collapsible defaultValue="EdTech" className="w-full">
                  {industries.map((industry) => (
                    <AccordionItem value={industry.title} key={industry.title} className="border-b last:border-b-0">
                      <AccordionTrigger className="flex items-center w-full py-3 text-left font-medium hover:no-underline data-[state=open]:text-brand-link-text">
                        {(() => {
                          const IconComponent = iconMap[industry.iconName];
                          return IconComponent ? <IconComponent className="mr-2 h-5 w-5 flex-shrink-0" aria-hidden="true" /> : null;
                        })()}
               ...
               <div className="py-6 border-t">
                 <h3 className="font-heading font-semibold mb-4 text-lg">Get In Touch</h3>
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <Button
                      ...
                      className="inline-flex items-center justify-center px-4 py-2.5 rounded text-sm font-medium"
