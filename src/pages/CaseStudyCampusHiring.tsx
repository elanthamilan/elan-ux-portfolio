        ...
        <article className="max-w-3xl mx-auto">
           ...
           <Card isExpanded={true}>
             <CardContent>
               ...
               <h1 className="text-5xl font-heading font-semibold mb-8 text-foreground leading-tight">
               ...
               <section className="mb-16">
                 <h2 className="text-4xl font-heading font-semibold mb-6 text-foreground">Project Background</h2>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-foreground/80 text-lg leading-relaxed">
                   ...
                   <div>
                     <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">User Pain Points:</h3>
                 ...
                 <div className="mt-12">
                   <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Business Problem:</h3>
                 ...
                 <div className="mt-12">
                   <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Background Context:</h3>
               ...
               <section className="mb-16">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Recruiters</h3>
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Placement Officers</h3>
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Students</h3>
               ...
               <section className="mb-16">
                 ...
                 <div className="border border-brand-light-gray-accent rounded-lg p-6 mb-6">
                   <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">User Research</h3>
               ...
               <section className="mb-16">
                 ...
                 <div className="space-y-6">
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Iteration 1: Form Structure</h3>
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Iteration 2: AI Autofill</h3>
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Iteration 3: External Tracking</h3>
               ...
               <section className="mb-16">
                 ...
                 <ol className="space-y-6 list-decimal list-inside marker:font-semibold marker:text-foreground">
                   <li className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-1 text-foreground inline">Seamless Access:</h3>
                   ...
                   <li className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-3 text-foreground">Job Creation Made Simple:</h3>
                   ...
                   <li className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-1 text-foreground inline">Leveraging SIS Data:</h3>
                   ...
                   <li className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-1 text-foreground inline">Approval & Tracking:</h3>
               ...
               <section className="mb-16">
                 ...
                 <div className="space-y-6">
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Effortless Discovery</h3>
                     <p className="text-foreground/80 leading-relaxed text-lg">Jobs appeared in the SIS feed with AI recommendations.</p>
                   </div>
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Frictionless Applications</h3>
                     <p className="text-foreground/80 leading-relaxed text-lg">Pre-filled forms using SIS data halved application time.</p>
                   </div>
                   <div className="border border-brand-light-gray-accent rounded-lg p-6">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Clear Next Steps</h3>
               ...
               <section className="mb-16">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Recruiter Flow</h3>
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Placement Officer Flow</h3>
                     <ul className="space-y-2 text-foreground/80 list-disc pl-5 text-lg">
                   ...
                   <div className="border border-brand-light-gray-accent rounded-lg p-5">
                     <h3 className="font-heading font-semibold text-2xl mb-2 text-foreground">Student Flow</h3>
                     <ul className="space-y-2 text-foreground/80 list-disc pl-5 text-lg">
