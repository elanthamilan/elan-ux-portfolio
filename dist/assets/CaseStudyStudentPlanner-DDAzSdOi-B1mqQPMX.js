import { j as jsxRuntimeExports, L as Link, R as React, r as reactExports, a as reactDomExports } from "./index-DWkr-VYD.js";
import { H as Header, S as SectionReveal, B as Badge, F as Footer, Z as ZoomableImage, C as ChevronRight, X } from "./SectionReveal-CANcsaBd-A1HtXhUZ.js";
import { A as ArrowLeft, B as BigImageCarousel, u as useEmblaCarousel, M as Maximize2, C as ChevronLeft } from "./BigImageCarousel-H-rAuVYl-HXIhBUUc.js";
const PlaceholderSVG = ({ width = 400, height = 300, text = "Design Process" }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width, height, viewBox: `0 0 ${width} ${height}`, xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width, height, rx: "16", className: "fill-slate-100 dark:fill-slate-800" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "20", y: "20", width: width - 40, height: "40", rx: "6", className: "fill-brand-primary dark:fill-brand-primary/70" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "30", y: "30", width: "80", height: "8", rx: "4", className: "fill-white dark:fill-slate-300", opacity: "0.9" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: width - 80, y: "30", width: "50", height: "8", rx: "4", className: "fill-white dark:fill-slate-300", opacity: "0.7" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "20", y: "80", width: width - 40, height: height - 120, rx: "8", className: "fill-white dark:fill-slate-700 stroke-slate-200 dark:stroke-slate-600", strokeWidth: "1" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: width / 2, cy: height / 2, r: "20", className: "fill-brand-secondary dark:fill-brand-secondary/70", opacity: "0.8" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "50%", y: "85%", textAnchor: "middle", dy: ".3em", fontSize: "14", fontWeight: "500", className: "fill-brand-secondary dark:fill-brand-secondary/70", children: text })
] });
  ...
  if (images.length === 1) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-lg relative group", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: "absolute top-2 right-2 bg-white/80 dark:bg-slate-700/80 hover:bg-white dark:hover:bg-slate-600 rounded-full p-1.5 shadow-md hover:shadow-lg transition-all z-10 opacity-0 group-hover:opacity-100",
          onClick: (e) => {
            e.stopPropagation();
            handleImageClick(0);
          },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionReveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mb-12 xs:mb-16 reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-br from-brand-secondary/12 to-brand-secondary/6 border-brand-secondary/20 shadow-brand-secondary/20 rounded-3xl overflow-hidden shadow-lg border-2 hover:shadow-xl transition-all duration-300 ease-in-out", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-8 md:px-8 md:py-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "group bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-brand-secondary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-lg text-brand-secondary mb-2 group-hover:text-brand-primary transition-colors", children: "Back to Home" }),
...
//# sourceMappingURL=CaseStudyStudentPlanner-DDAzSdOi-B1mqQPMX.js.map
