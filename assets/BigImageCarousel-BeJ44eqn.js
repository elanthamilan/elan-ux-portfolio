import { c as createLucideIcon, X } from "./Header-MKRXhXpG.js";
import { r as reactExports, j as jsxRuntimeExports, b as reactDomExports } from "./index-_Pnv69Rk.js";
/**
...
const PlaceholderSVG = ({ width = 800, height = 450, text = "UX Design Mockup" }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width, height, viewBox: `0 0 ${width} ${height}`, fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { width, height, rx: "32", fill: "#F2F8F7" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "40", y: "40", width: width - 80, height: "60", rx: "8", fill: "#3E8385" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "40", y: "120", width: (width - 80) * 0.7, height: "20", rx: "4", fill: "#B0B7C3" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "40", y: "150", width: (width - 80) * 0.5, height: "20", rx: "4", fill: "#D1D9E6" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "40", y: "200", width: width - 80, height: "200", rx: "12", fill: "#FBF9F8", stroke: "#E0E7EF", strokeWidth: "2" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: width / 2, cy: 300, r: "40", fill: "#385681" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "50%", y: "50%", textAnchor: "middle", dy: ".3em", fontSize: "24", fill: "#385681", fontWeight: "600", children: text })
] });
const BigImageCarousel = ({ images }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", children: [
    ...
    images.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: scrollPrev, className: "absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-brand-primary p-2 rounded-full shadow-md hover:shadow-lg transition-all z-10", "aria-label": "Previous image", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-5 h-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: scrollNext, className: "absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-brand-primary p-2 rounded-full shadow-md hover:shadow-lg transition-all z-10", "aria-label": "Next image", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-5 h-5" }) })
    ] }),
...
//# sourceMappingURL=BigImageCarousel-BeJ44eqn.js.map
